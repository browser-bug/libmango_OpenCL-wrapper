 ...
 */
void mango_peak_write_synchronization(mango_event_t *event, uint32_t value);
 ...
 * with 0
 */
uint32_t mango_peak_read_synchronization(mango_event_t *event);
